...
public class TransactionConsumerAndProducer {
    ...
    public static void main(String[] args) throws Exception{
        ...
        Consumer consumer = client.newConsumer()
                ...
                .batchReceivePolicy(BatchReceivePolicy.builder().maxNumMessages(3).build())
        ...
        producer.newMessage(transaction).value(new StringBuilder("tx message ").append(String.valueOf(msg.getMessageId())).toString().getBytes(
                StandardCharsets.UTF_8)).sendAsync().get();
        // Acknowledge
